...
<%@ include file="/WEB-INF/jsp/layout/top.jsp" %>
							...
							<div class="row justify-content-center">
								<div class="card border-width-3 border-radius-0 border-color-hover-dark mb-4 col-lg-6">
									<div class="card-body">
										<h4 class="font-weight-bold text-uppercase text-4 mb-3">학생 정보</h4>
										...
										<c:if test="${\"M\".equals(type)}">	
											<form action="${request.getContextPath()}/student/${row.memberNo}" method="post">
												<input type="hidden" name="_method" value="delete" />
												<input type="submit" value="삭제" class="btn btn-primary btn-modern float-right" />
											</form>
											<div class="col-lg-10">
												<a href="${request.getContextPath()}/student/${row.memberNo}/form"><input type="button" value="수정" class="btn btn-primary btn-modern float-right" /></a>
											</div>
										</c:if>
									</div>
								</div>
