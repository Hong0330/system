...
<div class="row justify-content-center">
	<div class="card border-width-3 border-radius-0 border-color-hover-dark mb-4 col-lg-6">
		<div class="card-body">
		<h4 class="font-weight-bold text-uppercase text-4 mb-3">학과 정보 수정</h4>
			<form action="${request.getContextPath()}/dept" method="post" class="needs-validation" onsubmit="return check(this)" >
				...
				<div class="form-group row">
					...
					<div class="col-lg-9">
						<input class="form-control" type="text" name="tel" value="${row.tel}" maxlength="12" onkeyup="inputPhoneNumber(this)" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
					</div>
				</div>
				<div class="form-group row mb-5">
					<label class="col-lg-3 font-weight-bold text-dark col-form-label form-control-label text-2 required">위치</label>
					<div class="col-lg-9">
						<input class="form-control" type="text" name="location" value="${row.location}" maxlength="33" required>
					</div>
				</div>
				<input type="submit" value="수정" class="btn btn-primary btn-modern float-right" />
				<div class="col-lg-10">
					<a href="/dept/${row.no}"><input type="button" value="취소" class="btn btn-primary btn-modern float-right" /></a>
				</div>
			</form>
